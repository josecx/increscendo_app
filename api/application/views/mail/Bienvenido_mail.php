...
">
  <div style="text-align: left; width: 600px; max-width: 100%; margin: 0 auto;">
    ...
    <div style="background-color: #fff; padding: 25px 40px 50px; margin: 20px 0 40px; box-shadow: 0 0 25px rgba(26, 108, 225, 0.1); border-radius: 4px">
      ...
      <h3 style="color: #222">¡Hola, Bienvenido a la familia Increscendo <?=$usuario['nombre'];?>!</h3>
      <p style=" margin-bottom: 10px">Tu usuario '<?=$usuario['usuario'];?>' ha sido habilitado, ya puedes ingresar a la aplicación utilizando la siguiente contraseña</p>

  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="javascript:;"
        ><i class="fas fa-box-open"></i> PRODUCTOS</a
      >
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <form
              @submit.prevent="_getDatos()"
              class="d-flex navbar-nav ml-auto"
            >
              <input
              ...
              />
              <button class="btn btn-outline-success ml-2 mr-2" type="submit">
          ...
          <div class="form-row col-sm-12 mt-2">
            <div class="col-sm-6">
              ...
              <select class="custom-select" v-model="form.categoria_id">
                <option value="">----------</option>
                <option
                  v-for="(i, key) in select.categoria"
                  :key="key"
                  :value="i.id"
                >
                  {{ i.nombre }}
            ...
            <div class="col-sm-6">
              ...
              <select class="custom-select" v-model="form.subcategoria_id">
                <option value="">----------</option>
                <option
                  v-for="(i, key) in getSubCategoria"
                  :key="key"
                  :value="i.id"
                >
                  {{ i.nombre }}
          ...
          <div class="form-row col-sm-12 mt-2">
            ...
            <div class="form-row col-sm-2 mt-2" v-if="reg">
              ...
              <div class="custom-control ml-4 custom-switch">
                ...
                />
                <label class="custom-control-label" for="switchFavorito"
                  >Favorito</label
                >
              </div>
            </div>
            ...
            <tr v-for="(i, key) in lista" :key="key">
              <td class="text-center">
                <a
                  ...
                  @click="imagen = i.imagen"
                >
                  <img
                    :src="'https://drive.google.com/uc?id=' + i.imagen"
                    class="img-thumbnail avatar m-0 p-0"
                  />
                </a>
              </td>
              ...
              <td class="align-middle">
                <small v-html="i.descripcion"></small>
              </td>
              ...
              <td class="align-middle text-center">
                <i v-if="i.favorito == 1" class="fas fa-star"></i>
              </td>
              <td class="align-middle">
                <button
                  @click="getListaImagen(i.id)"
                  v-b-modal.modal-1
                  class="btn btn-outline-primary"
                  title="Detalle de imágenes"
                >
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-body text-center">
            <img
              :src="'https://drive.google.com/uc?id=' + imagen"
              class="img-fluid"
          ...
          <form @submit.prevent="guardarProductoImagen">
            ...
            <div class="col-12 text-right">
              <button
                type="submit"
                :disabled="btnGuardando"
                class="btn btn-primary mr-0 mb-0"
              >
                <span
                  v-if="btnGuardando"
                  class="spinner-border spinner-border-sm"
  ...
  methods: {
    ...
    guardarProducto() {
      ...
      if (
        ...
        this.form.descripcion.trim() == null
      ) {
